...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://github.com/nishan2003481/Simple-Rename-Bot101")
        ],[
...
async def start(bot, msg, cb=True):   
    ...
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/anteikubotUpdates")
        ],[
...
async def about(bot, msg):
    me=await bot.get_me()
    Master=f"<a href=https://t.me/kazutoraSenpai>Kaneki</a> & <a href= https://t.me/AnteikuSupport>Support</a>"  
    Source="<a href= https://github.com/nishan2003481/Simple-Rename-Bot101>Click Here</a>"
    txt=f"<b>Bot Name: {me.mention}\nDeveloper: <a href= https://github.com/nishan2003481 >Kaneki</a>\nBot Updates: <a href= https://t.me/anteikubotUpdates >Anteiku Updates</a>\nMy Master's: {Master}\nSource Code: {Source}</b>"                 
    button= [[        
        InlineKeyboardButton("🚫 Close", callback_data="del"),
        InlineKeyboardButton("⬅️ Back", callback_data="start") 
    ]]  
